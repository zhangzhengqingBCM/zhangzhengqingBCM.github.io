...
# 音乐初始化
pygame.init()
touch = pygame.mixer.Sound("images/撞击.wav")  # 撞击音效
bgm = pygame.mixer.Sound("images/背景.wav")  # 背景音效
game_over = pygame.mixer.Sound("images/结束.wav")  # 结束音效
# 背景音乐播放
bgm.play(1000)
...
class MyCar(arcade.Window):
    ...
    def on_draw(self):
        ...
        self.speed = self.total_time // 5 + 5
    ...
    def create_carts(self):
        ...
        cart_list = ("images/大车1.png", "images/大车2.png",
                     "images/大车3.png","images/小车1.png","images/小车2.png")
        num = 2
        x = random.sample(
